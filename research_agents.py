...
def run_web_research_agent(external_client: AsyncOpenAI):
    ...
    while True:
        ...
        try:
            ...
            research_result = Runner.run_sync(web_research_agent, user_query)
            print(f"[{web_research_agent.name} Response] ")
